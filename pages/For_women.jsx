...
export default function Formen() {
    ...
    const filteredProducts = dummy2.filter((item) => item.name.toLowerCase().includes(searchTerms.toLowerCase()))
    return (
        <>
            <section className="bg-[#ebebd3]">
                <div className="max-w-[1300px] mx-auto pb-10">
                    <div className="pt-4 sm:pt-8 p-2">
                        <h1 className="text-3xl font-mono border-b-2 border-orange-400">Shop For Women</h1>
                    </div>
                            ...
                            {filteredProducts.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center gap-3 text-gray-600 flex justify-between">
